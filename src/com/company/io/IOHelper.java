...
//            planetElement.setTextContent(planet.getPlanetName());
...
//            jediNode.appendChild(createElementWithTextContent(document, "Rank", jedi.getRank()));
//            jediNode.appendChild(createElementWithTextContent(document, "Age", String.valueOf(jedi.getAge())));
...
//            jediNode.appendChild(createElementWithTextContent(document, "Planet", jedi.getPlanet().getPlanetName()));
